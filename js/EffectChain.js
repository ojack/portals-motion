...
var Blend = function(renderer, texture, texture2){
...
var Difference = function(renderer, texture, texture2){
	this.composer = new THREE.EffectComposer( renderer );
	this.composer.addPass( new THREE.TexturePass( texture, 1.0 ));
...
var GlassWarp = function(renderer, texture, lagTexture, texture2){
	this.composer = new THREE.EffectComposer( renderer );
